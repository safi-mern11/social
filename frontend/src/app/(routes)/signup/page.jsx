...
const Page = () => {
    const handleSubmit = (e) => {
        ...
        console.log(formData.get("avatar"), formData.get("password"), "email")
    ...
    return (
        <form onSubmit={(e) => { handleSubmit(e) }} className='absolute inset-0 m-auto max-w-[400px] w-full max-h-fit flex flex-col items-center'>
            ...
            <h1 className='text-[40px] font-semibold mt-[20px]'>Sign up</h1>
            ...
            <Link className='mt-[20px] hover:border-[#000] dark:hover:border-[#fff] border-transparent border-b pb-[1px]' href={"/login"}>login</Link>
        </form>
    )
}
